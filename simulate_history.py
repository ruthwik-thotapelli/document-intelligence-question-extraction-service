...
COMMITS = [
    ...
    ("build: add requirements, pyproject.toml and Makefile", ["requirements.txt", "pyproject.toml", "Makefile"]),
    ...
    ("chore: setup alembic for migrations", ["alembic.ini", "alembic/env.py", "alembic/script.py.mako"]),
    ...
    ("feat: implement authentication dependencies", ["app/api/__init__.py", "app/api/deps.py", "app/api/endpoints/__init__.py"]),
    ("feat: implement register and login endpoints", ["app/api/endpoints/auth.py"]),
    ("feat: implement secure local file storage service", ["app/services/__init__.py", "app/services/storage.py"]),
    ...
    ("test: setup pytest configuration and SQLite fixtures", ["tests/__init__.py", "tests/conftest.py"]),
    ...
    ("docs: polish README with Mermaid diagrams and badges", []) # Will just add remaining modified files
]
...
def main():
    ...
    # Force push
    run("git remote add origin https://github.com/ruthwik-thotapelli/document-intelligence-question-extraction-service.git")
